...
```
## Output:
![output](https://github.com/RuchithaReddy28/PCA-Matrix-summation-with-a-2D-grid-and-2D-blocks.-Adapt-it-to-integer-matrix-addition.-/blob/main/t.png?raw=true)
